...
const PROJECTS = [
  ...
  {
    id: 2,
    title: 'Posa Parquet Mansarda — Rovere Naturale',
    category: 'Posa Parquet',
    location: 'Bergamo',
    material: 'Parquet prefinito rovere — posa dritta in mansarda',
    image: '/portfolio/spina-pesce-camino-01.jpg',
    large: false,
  },
  {
    id: 3,
    title: 'Parquet Merbau — Finitura Lucida',
    category: 'Posa Parquet',
    location: 'Lombardia',
    material: 'Parquet merbau con finitura lucida a olio',
  ...
  },
  {
    ...
    location: 'Lombardia',
    material: 'Levigatura professionale e rifinitura parquet esistente',
