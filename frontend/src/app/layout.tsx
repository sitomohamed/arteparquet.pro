...
export const metadata: Metadata = {
  title: {
    default: 'Arteparquet | Posa e Restauro Parquet in Italia — Dal 2004',
    template: '%s | Arteparquet',
  },
  description:
    'Specialisti in posa, restauro e levigatura parquet dal 2004. SPC, PVC, laminato. Ex team Teatro alla Scala di Milano. Operiamo in tutta Italia. Sopralluogo e preventivo gratuiti.',
  keywords: [
    'posa parquet',
    'restauro parquet',
    'levigatura parquet',
  ...
  openGraph: {
    title: 'Arteparquet | Maestri del Parquet in Italia dal 2004',
