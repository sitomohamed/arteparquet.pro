...
const PROJECTS = [
  { id: 1, title: 'Parquet a Spina di Pesce — Rovere', category: 'Posa Parquet', location: 'Bergamo', surface: '85 mq', material: 'Parquet massello rovere — posa a spina di pesce con finitura lucida', year: '2026', image: '/portfolio/google-spina-pesce-finitura-01.jpg', large: true },
  { id: 2, title: 'Levigatura Professionale — Parquet Esistente', category: 'Restauro & Levigatura', location: 'Lombardia', surface: '60 mq', material: 'Levigatura, carteggiatura e rifinitura su parquet esistente', year: '2026', image: '/portfolio/google-levigatura-mosaico-01.jpg', large: false },
  { id: 3, title: 'Posa Parquet in Rovere — Camera da Letto', category: 'Posa Parquet', location: 'Bergamo', surface: '30 mq', material: 'Parquet rovere posa a spina di pesce in corso — camera residenziale', year: '2026', image: '/portfolio/google-posa-corridoio-progress-01.jpg', large: false },
  { id: 4, title: 'Parquet Listoni — Finitura Lucida', category: 'Posa Parquet', location: 'Lombardia', surface: '110 mq', material: 'Posa di listoni in rovere naturale — salone principale', year: '2025', image: '/portfolio/google-posa-listoni-01.jpg', large: false },
  { id: 5, title: 'Parquet con Bordo e Intarsio', category: 'Lavorazione Speciale', location: 'Bergamo', surface: 'Decorazione', material: 'Parquet con fascia perimetrale e filetto bianco', year: '2025', image: '/portfolio/google-parquet-bordo-intarsio-01.jpg', large: false },
  { id: 6, title: 'Posa Parquet — Rovere Naturale', category: 'Posa Parquet', location: 'Bergamo', surface: '40 mq', material: 'Parquet a spina di pesce in rovere naturale in stanza residenziale', year: '2025', image: '/portfolio/google-spina-pesce-stanza-01.jpg', large: false },
