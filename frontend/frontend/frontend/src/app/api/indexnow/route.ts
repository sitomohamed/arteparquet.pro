...
export async function GET(request: NextRequest) {
  ...
  // SECURITY: Constant-time secret comparison to prevent timing attacks
  ...
  const secretValid = secret.length === expectedSecret.length &&
    ...
    : secret === expectedSecret // Fallback for edge cases
